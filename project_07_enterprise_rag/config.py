...
LLM_PROVIDER = os.getenv("ENTERPRISE_RAG_LLM_PROVIDER", "qwen")
EMBEDDING_PROVIDER = os.getenv("ENTERPRISE_RAG_EMBEDDING_PROVIDER", "qwen")
EMBEDDING_MODEL = os.getenv("ENTERPRISE_RAG_EMBEDDING_MODEL", "text-embedding-v4")
